...
#64bit version 2, we use the whole 64 Bit registers.
...
#
# data_items(,%rdi,8), data_items is the address of the list. the 0 item is 3
# The Index Register will be calculated with %rdi*4
